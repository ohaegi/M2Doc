...
public class TemplatePackageImpl extends EPackageImpl implements TemplatePackage {
     ...
     * @generated
     */
    private EClass userDocDestEClass = null;
     ...
     * @generated
     */
    public EClass getUserDocDest() {
        return userDocDestEClass;
    }
     ...
     * @generated
     */
    public EAttribute getUserDocDest_Id() {
        return (EAttribute)userDocDestEClass.getEStructuralFeatures().get(0);
    }
	...
	public void createPackageContents() {
        ...
        userDocDestEClass = createEClass(USER_DOC_DEST);
        createEAttribute(userDocDestEClass, USER_DOC_DEST__ID);
	...
	public void initializePackageContents() {
        ...
        userDocDestEClass.getESuperTypes().add(this.getCompound());
        ...
        initEClass(userDocDestEClass, UserDocDest.class, "UserDocDest", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getUserDocDest_Id(), ecorePackage.getEString(), "id", null, 0, 1, UserDocDest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
