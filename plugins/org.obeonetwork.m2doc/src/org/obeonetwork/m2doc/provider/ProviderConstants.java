...
public interface ProviderConstants {
    ...
    /**
     * The key used in the map passed to {@link IProvider} to define a flag indicate if representation (Sirius diagram or table) should be refresh before M2Doc generation.
     */
    String REPRESENTATION_FLAG_REFRESH_KEY = "refreshFlag";
    /**
