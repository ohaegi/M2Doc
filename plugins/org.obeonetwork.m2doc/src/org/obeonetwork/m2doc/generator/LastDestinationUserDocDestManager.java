 ...
 * @author ohaegi
 */
public class LastDestinationUserDocDestManager {
    /**
     ...
     */
    public LastDestinationUserDocDestManager(String destinationPathFileName)
            ...
            if (eObject instanceof UserDocDest) {
                ...
                if (userDocDest.getId() != null) {
                    ...
                    if (mapIdUserDocDest.containsKey(id)) {
                        // TODO mettre warning de non unicite des id / seule la première est prise en compte
                        // Voir comment faire
                    } else {
