...
public class TemplateProcessor extends TemplateSwitch<AbstractConstruct> {
    ...
    private Map<String, Object> setupParametersMap(TableClient object, IProvider provider)
        ...
        if (targetConfObject instanceof Generation) {
            parameters.put(ProviderConstants.REPRESENTATION_FLAG_REFRESH_KEY,
                    ((Generation) targetConfObject).isRefreshDiagram());
        } else {
            parameters.put(ProviderConstants.REPRESENTATION_FLAG_REFRESH_KEY, false);
        }
     ...
     */
    public static void setErrorMessageToRun(String errorMessage, XWPFRun imageRun) {
