...
To test M2Doc, we need compare docx documents. WORD have a tool to do that.
...
You can choose documents to compare :

	!images/image014.png!

Files tagged "Compatible mode" are files edited by WORD.

You can show quickly difference between documents
