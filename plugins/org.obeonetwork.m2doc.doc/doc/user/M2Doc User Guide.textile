...
In both case Sirius diagram and Sirius table providers, the M2Doc generation can occur with a closed Sirius representation view. So the semantic and graphical models could be unsynchronized. A parameter in genConf model define the strategy to follow during M2Doc generation.

!images/image019.png!

The boolean parameter "Refresh Diagram" can be used to define following update strategy : 
...
Becarefull, enabling update representation could be expensive in term of time machine. 
