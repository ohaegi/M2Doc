...
/**
 * This class is a copy of Sirius code modified to support synchrone arrange all.
 * A feature resquest was created to support synchrone aspect : TODO put here ticket number.
 * 
 ...
 */
public class SiriusSynchroneCanonicalLayoutCommand extends RecordingCommand implements NonDirtying {
    // CHECKSTYLE:OFF
     ...
     */
    public SiriusSynchroneCanonicalLayoutCommand(TransactionalEditingDomain domain, DiagramEditPart diagramEditPart) {
     ...
     */
    public SiriusSynchroneCanonicalLayoutCommand(TransactionalEditingDomain domain, IGraphicalEditPart parentEditPart,
